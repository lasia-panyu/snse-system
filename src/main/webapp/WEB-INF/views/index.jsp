...
<html>
  <head>
    ...
    <link href="/snse/resources/css/charts-graphs.css" rel="stylesheet">
    <!-- Datepicker CSS -->
    <link rel="stylesheet" type="text/css" href="/snse/resources/css/datepicker.css">
  ...
  <body>
    ...
    <header>
      <a href="index.html" class="logo">
        <img src="/snse/resources/img/logo.png" alt="Logo"/>
      </a>
...
<!--                 <div class="mini-widget-footer center-align-text">
    ...
    <!-- jQuery UI JS -->
    <script src="/snse/resources/js/jquery-ui-v1.10.3.js"></script>

    <!-- Just Gage -->
    <script src="/snse/resources/js/justgage/justgage.js"></script>
    <script src="/snse/resources/js/justgage/raphael.2.1.0.min.js"></script>

    <!-- Flot Charts -->
    <script src="/snse/resources/js/flot/jquery.flot.js"></script>
    <script src="/snse/resources/js/flot/jquery.flot.orderBar.min.js"></script>
    <script src="/snse/resources/js/flot/jquery.flot.stack.min.js"></script>
    <script src="/snse/resources/js/flot/jquery.flot.pie.min.js"></script>
    <script src="/snse/resources/js/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/snse/resources/js/flot/jquery.flot.resize.min.js"></script>

    <!-- Custom JS -->
    <script src="/snse/resources/js/menu.js"></script>
    <script src="/snse/resources/js/custom-index2.js"></script>
